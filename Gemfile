...
gem 'rails_cms', gitee: 'work-design/rails_cms'
...
gem 'rails_sync', gitee: 'work-design/rails_sync'
...
gem 'rails_douyin', gitee: 'work-design/rails_douyin'
