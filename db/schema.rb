...
ActiveRecord::Schema[8.0].define(version: 2025_02_07_072950) do
  ...
  create_table "agential_agencies", force: :cascade do |t|
    ...
    t.bigint "client_id"
    t.bigint "agent_id"
    t.decimal "commission_ratio", precision: 4, scale: 2
    t.string "note"
  end
  ...
  create_table "bench_facilitates", force: :cascade do |t|
    ...
    t.string "good_type"
    t.json "card_price", default: {}
    t.json "wallet_price", default: {}
    t.decimal "invest_ratio", default: "0.0"
    t.bigint "organ_id"
  ...
  create_table "crm_sources", force: :cascade do |t|
    ...
    t.integer "fixed_width", default: 0
    t.json "parent_ancestors", default: {}
    t.string "sku"
  ...
  create_table "growth_praise_incomes", force: :cascade do |t|
    ...
    t.decimal "profit_amount", precision: 10, scale: 2, default: "0.0"
    t.decimal "royalty_amount", precision: 10, scale: 2, default: "0.0"
  ...
  create_table "org_organs", force: :cascade do |t|
    ...
    t.json "factory_settings"
    t.json "theme_settings", default: {}
    t.string "dispatch"
    t.string "invite_token"
    t.bigint "cache_id"
  ...
  create_table "profiled_address_users", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "inviter_id"
    t.decimal "commission_ratio", precision: 4, scale: 2, default: "0.0"
    t.string "kind"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "qingflow_items", force: :cascade do |t|
    ...
    t.bigint "organ_id"
    t.string "linked_uid"
    t.json "primary_attrs"
    t.json "attrs"
    t.bigint "version_id"
    t.string "record_key"
    t.json "cached_answers"
    t.json "cached_table"
    t.datetime "last_sync_at"
    t.datetime "apply_at"
    t.json "linked_audits"
    t.json "linked_logs"
    t.string "note"
    t.string "uid"
    t.json "code_answers"
  ...
  create_table "ship_box_hosts", force: :cascade do |t|
    ...
    t.decimal "invest_ratio"
    t.string "good_type"
    t.integer "tradable_count"
  ...
  create_table "trade_cart_promotes", force: :cascade do |t|
    ...
    t.decimal "based_amount", default: "0.0"
    t.decimal "computed_amount", default: "0.0"
    t.decimal "amount", default: "0.0"
    t.string "note"
  ...
  create_table "trade_carts", force: :cascade do |t|
    ...
    t.bigint "address_id"
    t.integer "lock_version"
    t.decimal "original_amount", default: "0.0"
    t.bigint "member_id"
    t.bigint "member_organ_id"
  ...
  create_table "trade_holds", force: :cascade do |t|
    ...
    t.json "wallet_amount"
    t.decimal "estimate_amount"
    t.json "estimate_wallet_amount"
    t.decimal "invest_amount"
    t.json "extra"
    t.string "job_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "wechat_apps", force: :cascade do |t|
    ...
    t.json "webview_domain_registered"
  ...
  create_table "wechat_corps", force: :cascade do |t|
    ...
    t.string "location"
    t.json "auth_corp_info"
    t.json "auth_user_info"
    t.json "register_code_info"
    t.json "agent"
    t.string "access_token"
    t.datetime "access_token_expires_at"
    t.string "jsapi_ticket"
  ...
  create_table "wechat_suites", force: :cascade do |t|
    ...
    t.string "redirect_controller"
    t.string "redirect_action", default: "index"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "kind"
  end
