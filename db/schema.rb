...
ActiveRecord::Schema[7.1].define(version: 2024_02_16_072432) do
  ...
  create_table "solid_queue_blocked_executions", id: { scale: 8 }, force: :cascade do |t|
    t.bigint "job_id", scale: 8, null: false
    t.string "queue_name", null: false
    t.integer "priority", scale: 4, default: 0, null: false
  ...
  create_table "solid_queue_claimed_executions", id: { scale: 8 }, force: :cascade do |t|
    t.bigint "job_id", scale: 8, null: false
    t.bigint "process_id", scale: 8
    t.datetime "created_at", null: false
    t.index ["job_id"], name: "index_solid_queue_claimed_executions_on_job_id", unique: true
    t.index ["process_id", "job_id"], name: "index_solid_queue_claimed_executions_on_process_id_and_job_id"
  end

  create_table "solid_queue_failed_executions", id: { scale: 8 }, force: :cascade do |t|
    t.bigint "job_id", scale: 8, null: false
    t.text "error"
    t.datetime "created_at", null: false
  ...
  create_table "solid_queue_jobs", id: { scale: 8 }, force: :cascade do |t|
    t.string "queue_name", null: false
  ...
  create_table "solid_queue_pauses", id: { scale: 8 }, force: :cascade do |t|
    t.string "queue_name", null: false
    t.datetime "created_at", null: false
    t.index ["queue_name"], name: "index_solid_queue_pauses_on_queue_name", unique: true
  end

  create_table "solid_queue_processes", id: { scale: 8 }, force: :cascade do |t|
    t.string "kind", null: false
    t.datetime "last_heartbeat_at", null: false
    t.bigint "supervisor_id", scale: 8
    t.integer "pid", scale: 4, null: false
    t.string "hostname"
    t.text "metadata"
    t.datetime "created_at", null: false
  ...
  create_table "solid_queue_ready_executions", id: { scale: 8 }, force: :cascade do |t|
    t.bigint "job_id", scale: 8, null: false
    t.string "queue_name", null: false
    t.integer "priority", scale: 4, default: 0, null: false
    t.datetime "created_at", null: false
  ...
  create_table "solid_queue_scheduled_executions", id: { scale: 8 }, force: :cascade do |t|
    t.bigint "job_id", scale: 8, null: false
    t.string "queue_name", null: false
    t.integer "priority", scale: 4, default: 0, null: false
  ...
  create_table "solid_queue_semaphores", id: { scale: 8 }, force: :cascade do |t|
    t.string "key", null: false
    t.integer "value", scale: 4, default: 1, null: false
    t.datetime "expires_at", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
